...
function close_popup(id, channelName) {
...
function register_popup(id, name) {
    ...
    element += '<div class="popup-head-right"><a href="javascript:close_popup(\''+ id +'\', \''+ channelName + '\');">&#10005;</a></div>';
    element += '<div style="clear: both"></div></div>';
    element += '<div class="popup-messages" id = "popup-messages-' + channelName + '"></div>';
    element += '<form class="fb-chatMsgForm" id="' + name + '"><textarea class="fb-chatMsgBox" id="fb-chatMsgBox' + name + '"></textarea><br/>';
